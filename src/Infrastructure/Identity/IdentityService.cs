...
public class IdentityService : IIdentityService
{
    ...
    public async Task<(Result Result, string UserId)> CreateUserAsync(int BaseCurrencyID, string AccountDescription, string userName, string password)
    {
        var user = new Users
        {
            UserName = userName,
    ...
    public async Task<Result> DeleteUserAsync(Users user)
    {
