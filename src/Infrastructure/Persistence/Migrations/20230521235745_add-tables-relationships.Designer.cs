...
namespace ExCurrency.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20230521235745_add-tables-relationships")]
    partial class addtablesrelationships
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ExCurrency.Domain.Entities.TodoList", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ExCurrency.Infrastructure.Identity.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("ExCurrency.Domain.Entities.ExCurrenciesDashboard", b =>
                {
                    b.HasOne("ExCurrency.Infrastructure.Identity.ApplicationUser", null)
                        .WithMany("ExCurrenciesDashboard")
                        .HasForeignKey("ApplicationUserId");

                    b.HasOne("ExCurrency.Domain.Entities.Currencies", null)
                        .WithMany("ExCurrenciesDashboard")
            ...
            modelBuilder.Entity("ExCurrency.Domain.Entities.TodoItem", b =>
                {
                    b.HasOne("ExCurrency.Domain.Entities.TodoList", "List")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("ExCurrency.Domain.Entities.TodoList", b =>
                {
                    b.OwnsOne("ExCurrency.Domain.ValueObjects.Colour", "Colour", b1 =>
                        {
